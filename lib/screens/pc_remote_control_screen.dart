      ...
      child: GridView.count(
        ...
        children: [
          RemoteButton(
            ...
            label: 'Vol Up',
            backgroundColor: AppColors.standardButton,
            onPressedAsync: () => RemoteApiService.mediaControl('volumeup'),
            errorTitle: 'System Control Failed',
          ),
          RemoteButton(
            ...
            label: 'Previous',
            backgroundColor: AppColors.standardButton,
            onPressedAsync: () => RemoteApiService.mediaControl('prevtrack'),
            errorTitle: 'System Control Failed',
          ),
          RemoteButton(
            ...
            label: 'Play/Pause',
            backgroundColor: AppColors.standardButton,
            onPressedAsync: () => RemoteApiService.mediaControl('playpause'),
            errorTitle: 'System Control Failed',
          ),
          RemoteButton(
            ...
            label: 'Next',
            backgroundColor: AppColors.standardButton,
            onPressedAsync: () => RemoteApiService.mediaControl('nexttrack'),
            errorTitle: 'System Control Failed',
          ),
          RemoteButton(
            ...
            label: 'Vol Down',
            backgroundColor: AppColors.standardButton,
            onPressedAsync: () => RemoteApiService.mediaControl('volumedown'),
            errorTitle: 'System Control Failed',
          ),
          RemoteButton(
            ...
            label: 'Mute',
            backgroundColor: AppColors.standardButton,
            onPressedAsync: () => RemoteApiService.mediaControl('volumemute'),
            errorTitle: 'System Control Failed',
          ),
        ],
      ),
      ...
      child: Row(
        children: [
          LargeUtilityButton(
            ...
            onPressedAsync: () => RemoteApiService.openBrowser(),
            errorTitle: 'System Control Failed',
          ),
          ...
          LargeUtilityButton(
            ...
            backgroundColor: AppColors.standardButton,
            height: buttonHeight,  // NEW: Pass responsive height
            onPressedAsync: () => RemoteApiService.takeScreenshot(),
            errorTitle: 'System Control Failed',
          ),
        ],
      ),
